...
import GeneratorCustomReport from './GeneratorCustomReport/GeneratorCustomReport';
...
export default function AttendanceCustomReport() {
    ...
    return (
     ...
     <div className = "custom_detail_date">
      ...
      />
           ...
           {customAdd&&(
             <GeneratorCustomReport setCustomAdd = {setCustomAdd}></GeneratorCustomReport>
           )}
              </div>
