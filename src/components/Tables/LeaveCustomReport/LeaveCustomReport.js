...
import GenerateLeaveReport from './GenerateLeaveReport/GenerateLeaveReport';
...
export default function LeaveCustomReport() {
    ...
    return (
     ...
     <div className = "custom_detail_date">
      ...
      />
           ...
           {customAdd&&(
             <GenerateLeaveReport setCustomAdd = {setCustomAdd}></GenerateLeaveReport>
           )}
              </div>
