...
export default function CurrentJoined() {
          ...
          <table class="table_ondash table--shaded_ondash">
            <thead class="table__head_ondash">
              <tr class="table__row_ondash">
                ...
                <td class="table__cell_ondash table__cell--no-wrap_ondash">Status</td>
            ...
            <tr className="spacer_ondash"></tr>
              <tr class="table__row_ondash" key={index} >
                ...
                <td class="UserTable__name table__cell_ondash table__cell--no-wrap_ondash"style = {{color : "red"}}>
                {ele.Status}
                </td>
      ...
      top: "0.5rem"}} alt = ""></img>
          ...
          <div className="table-footer">
                  ...
                  <div className="footer-right">  
                      ...
                      <button className="btn btn1-w btn-inactive">{`<< Previous`}</button>
                      ...
                      <button className="btn btn1-w btn-inactive">{`Next >>`}</button>
                  </div>
              </div>
        </div>
      </div>
