...
const Sidebar = ({ setHeading }) => {
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
          ...
          <span>Employees</span>
              ...
              <Link to="/tickets">
      <li  className={active==="tickets"?"activeTab":""} 
      onClick={()=>{setActive("tickets");
  
      heading.changeHeading({type:"CHANGE_HEADING",payload:"Tickets"})
  ...
  <path fill-rule="evenodd" d="M0 0h1v15h15v1H0V0zm10 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V4.9l-3.613 4.417a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61L13.445 4H10.5a.5.5 0 0 1-.5-.5z"/>
          ...
          <span>Performance</span>
              ...
              <Link to="/attendence">
      <li
      className={active==="attendence"?"activeTab":""} 
      onClick={()=>{setActive("attendence");

      heading.changeHeading({type:"CHANGE_HEADING",payload:"Attendence"})
    }}
      >
