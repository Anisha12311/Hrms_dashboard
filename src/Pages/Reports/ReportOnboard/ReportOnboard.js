...
import OnboardReport from './OnboardReport/OnboardReport';
import './ReportOnboard.scss'
export default function ReportOnboard() {
    ...
    <div>
             <div className="navOptions1">
                ...
                {navClicked === "Candidatedetails" && <OnboardReport> </OnboardReport>}
                {navClicked === "QuickReport" && <OnboardCustomizedReprot> </OnboardCustomizedReprot>}
